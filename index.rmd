...
Lo primero que vamos hacer es conocer cuáles son las características del objeto que hemos generado.  Lo primero cargar los datos. Vuelva a descargar los datos desde [aquí](https://github.com/Ciespinosa/ConociendoDatos/blob/master/AMEBIASIS_LOJA)
